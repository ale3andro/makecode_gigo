...
; Virtual methods: 0 / 0
; generated code sizes (bytes): 2128 (incl. 1408 user, 664 helpers, 12 vtables, 44 lits); src size 0
; assembly: 1415 lines; density: 704 bytes/stmt; (2 stmts)
; total bytes: 292944 (62.2% of 460.0k flash with 178096 free)
...
; start
    ...
    .hex 49042AE2C890794D ; hex template hash
